...
<body>
    ...
    <form name="contactForm" onsubmit="return validateForm()" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <input type="text" name="mobile" maxlength="12"  value="<?php echo $_GET['mobile']; ?>">
    ...
    <?php
     ...
     $id= $name = $email = $mobile = $course = $gender = $hobbies=  "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE form_details SET name='$name' , email='$email', mobile='$mobile' , course='$course', gender='$gender',hobbies='$newvalues', image='$target_file'   WHERE id='$id'";
